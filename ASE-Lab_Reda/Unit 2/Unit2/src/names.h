 ...
 #define light_data ADC_0.CDR[2].B.CDATA
 #define pot_data ADC_0.CDR[4].B.CDATA
 #define temp_data ADC_0.CDR[5].B.CDATA
 
 #define BT5 SIU.GPDI[0].R
 #define BT6 SIU.GPDI[1].R
